...
# Projects section
    ...
    with st.expander("🏃‍ Hospital management Project"):
        st.write("To design and implement an intelligent  Hospital MIS")
        st.markdown("[GitHub Repository](https://github.com/your-repo)")
        st.image("project1.png", caption="GDP Analysis Visualization")

    with st.expander(" 🏫 School MIS Design "):
        st.write("Design Systems For school ")
...
# Contact section
    ...
    st.write("📧 dusenayojemima@gmail.com")
...
# Footer
st.sidebar.write("---")
st.sidebar.write("🔹 Made by dusenayo jemima")